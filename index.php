...
<img src="liton.jpg" alt="" style="border-radius: 100%; border: 2px solid white;" width="200" height="200" title="Visit admin Profile"/></a></div></div></br><br>
<br>
<div id="center">
<strong><div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link"> </a></h3> <li><a ="http://bd-token.herokuapp.com" target="_blank"><input class="button"style="width:20%" type="button" value="GET SCURE TOKEN"></a><br><br>
...
<font color=" white"="" size="10"> MADE BY ::  <font color="red">LITON MOLLA <br>
...
<b>-LITON MOLLA-</b><br>
<img src="https://graph.facebook.com/100011065958364/picture?type=large" alt="Profile" style="width:250px; height:250px;border: 2px;border-radius: 50%;" data-pagespeed-url-hash="1820703895" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
<br><b>WELCOME TO BOT BY LITON MOLLA</b><br><br>
<b></b><br>  
